...
IL2CPP_EXTERN_C Il2CppIUnknown* CreateComCallableWrapperFor_List_1_tB5A0E21D0A7C39DF93D616FD5B94C4737A083E35(RuntimeObject* obj)
{
	void* memory = il2cpp::utils::Memory::Malloc(sizeof(List_1_tB5A0E21D0A7C39DF93D616FD5B94C4737A083E35_ComCallableWrapper));
	if (memory == NULL)
	{
		il2cpp_codegen_raise_out_of_memory_exception();
	}

	return static_cast<Il2CppIManagedObjectHolder*>(new(memory) List_1_tB5A0E21D0A7C39DF93D616FD5B94C4737A083E35_ComCallableWrapper(obj));
}
